<template>
	...
	>
		<div class="hero-body">
			<div class="container">
				...
				<p class="title is-1 has-text-white is-italic">Zhaolin Lau</p>
	...
	<section class="section" id="about">
		<div class="container">
			<p class="title has-text-centered">About Me</p>
		</div>
	</section>

	<section class="section" id="skills">
		<div class="container">
			<p class="title has-text-centered mt-3">My Skills</p>
		</div>
	</section>
		...
		<div class="container">
			...
			<div class="columns is-multiline">
              ...
              <div class="card-content">
                <figure class="image">
                  <img src="./assets/utmfd.png" alt="Admin template screenshot">
                </figure>
              </div>
	...
	<section class="section" id="contact">
		<div class="container">
			<p class="title has-text-centered">Contact Me</p>
		</div>
	</section>
</template>
