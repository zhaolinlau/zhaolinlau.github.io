import { a as useHead, e as useNuxtApp, d as useRuntimeConfig } from '../server.mjs';
import { ref, resolveComponent, withCtx, createVNode, createTextVNode, useSSRContext, defineComponent, computed, h } from 'vue';
