...
import { defineEventHandler, handleCacheHeaders, createEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseStatus, getRequestHeader, setResponseHeader, getRequestHeaders, getRequestHost, getRequestProtocol, getQuery as getQuery$1, setHeader, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, createError } from 'file://C:/xampp/htdocs/zhaolinlau.github.io/node_modules/.pnpm/h3@1.7.1/node_modules/h3/dist/index.mjs';
import { createRenderer } from 'file://C:/xampp/htdocs/zhaolinlau.github.io/node_modules/.pnpm/vue-bundle-renderer@1.0.3/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file://C:/xampp/htdocs/zhaolinlau.github.io/node_modules/.pnpm/devalue@4.3.2/node_modules/devalue/index.js';
import { renderToString } from 'file://C:/xampp/htdocs/zhaolinlau.github.io/node_modules/.pnpm/vue@3.3.4/node_modules/vue/server-renderer/index.mjs';
...
import { parseURL, withoutBase, joinURL, getQuery, withQuery, hasProtocol, withHttps, withoutProtocol, withBase } from 'file://C:/xampp/htdocs/zhaolinlau.github.io/node_modules/.pnpm/ufo@1.2.0/node_modules/ufo/dist/index.mjs';
...
const _dYZuvYnLBC = (function(nitro) {
...
const _lazy_iZ76U4 = () => Promise.resolve().then(function () { return renderer$1; });
...
const getClientManifest = () => import('file://C:/xampp/htdocs/zhaolinlau.github.io/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getStaticRenderedHead = () => Promise.resolve().then(function () { return _virtual__headStatic$1; }).then((r) => r.default || r);
const getServerEntry = () => import('file://C:/xampp/htdocs/zhaolinlau.github.io/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
